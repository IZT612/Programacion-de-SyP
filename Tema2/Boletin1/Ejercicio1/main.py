...
if __name__ == "__main__":
    ...
    while(contador < cantidad_procesos):
        ...
        numero_limite = int(input("Introduzca un número para sumar todos los números desde el 1 hasta el que introduzca: "))

        procesos.append(Process(target=sumarNumeros, args=(numero_limite,)))
